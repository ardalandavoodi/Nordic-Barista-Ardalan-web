					...
					<div id="article-page">
						<div class="row" >
							<div id="short-text" class="thumbnail">
							  <img id="img1" class="img-rounded" src="images/article images/images.jpg" width="170" height="170">
								<?php
								$conn = OpenCon();
								$sql = "SELECT * FROM `article` WHERE `article-id`=4";
							...
							<div id="short-text" class="thumbnail">
							  <img id="img1" class="img-rounded" src="images/article images/street.jpg" alt="..." width="170" height="170">
							  <?php
								$conn = OpenCon();
								$sql = "SELECT * FROM `article` WHERE `article-id`=1";
								$result = $conn->query($sql);
							...
							<div id="short-text" class="thumbnail">
							  <img id="img1" class="img-rounded" src="images/article images/download.jpg" alt="..." width="170" height="170">
							  <?php
								$conn = OpenCon();
								$sql = "SELECT * FROM `article` WHERE `article-id`=8";
								$result = $conn->query($sql);
