			...
			<div class="row">
				<div id="header-top-fixed">
					<div id="header-top1">
						...
						<a class="link-search" href="search-article.html" data-toggle="tooltip" title="Search in the article">
					...
					<div id="header-top2">
						...
						<ul id="nav-header" class="nav" data-spy="scroll" data-target=".navbar" data-offset="50">
							<li class="nav-item">
					...
					<div id="article-page">
						<div class="row" >
							...
							<div id="short-text" class="thumbnail">
							  ...
							  <?php
								$conn = OpenCon();
								$sql = "SELECT * FROM `article` WHERE `article-id`=3";
								$result = $conn->query($sql);
